...
#Hai loại Hierarchical Clustering
...
#Gộp 2 cụm gần nhất
#ặp bước 2-3 cho đến khi còn 1 cụm
set.seed(42)
...
#Chọn eps tối ưu: k-distance graph
#Phương pháp k-NN distance:
#Với mỗi điểm, tính khoảng cách đến láng giềng thứ k (k = minPts)
#Sắp xếp khoảng cách tăng dần
#Vẽ biểu đồ
#Tìm điểm “khuỷu tay” → eps tối ưu
# Tính k-NN distance
k <- 5  # minPts
...
plot(customers_db$Age, customers_db$Income,
     ...
     xlab = "Tuổi", ylab = "Thu nhập",
     main = "DBSCAN")
#Dự án thực hành: So sánh 3 thuật toán Clustering
#chuẩn bị dữ liệu
set.seed(2026)
...
# Centroids
km_result$centers
#Thuật toán 2: Hierarchical Clustering
...
#so sánh trực quan về 3 thuật toán 
par(mfrow = c(3, 3))
